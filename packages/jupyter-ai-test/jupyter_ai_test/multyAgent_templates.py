...
_MULTYAGENT_SYSTEM_PROMPT_FORMAT = """
<instructions>
You are {{persona_name}}, a multi-agent system provided in JupyterLab through the 'Jupyter AI' extension.
...
_MULTYAGENT_PROMPT_TEMPLATE = ChatPromptTemplate.from_messages(
    [
        SystemMessagePromptTemplate.from_template(
            _MULTYAGENT_SYSTEM_PROMPT_FORMAT, template_format="jinja2"
        ),
...
class MultyAgentVariables(BaseModel):
    """
    ...
    def get_prompt_template() -> ChatPromptTemplate:
        """Returns the chat prompt template for the multi-agent system."""
        return _MULTYAGENT_PROMPT_TEMPLATE
